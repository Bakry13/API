...
public class AlertingErrorTest 
{
	...
	String TCPath = System.getProperty("user.dir") + "/Inputs/" + "AlertingErrorHandling.xlsx";
//====================================================================================================================	
	@BeforeMethod
	void StartTestCase()
	{	try {
...
//==================================Unauthorized - ConsumptionRequestWithoutMSISDN===============================================
	@Test(priority = 1)
	 ...
	 {	try {
		    response = AlertingErrorHandling.AlertingRequestWithoutMsisdn(ExcelInit.MSISDN, ExcelInit.Password);
...
//==================================Unauthorized - ConsumptionRequestWithoutToken==============================================================
	...
	{	try {
		    response = AlertingErrorHandling.AlertingRequestWithoutToken(ExcelInit.MSISDN, ExcelInit.Password);
		    jsonString = Verification.Unauthorized(response);
		} catch (Exception e) {ExtentReport.test.log(LogStatus.FAIL, "Exception in code happened and Auth status code is: " + Auth.StatusCode);
		  e.printStackTrace();}
	}
//=====================================Not Found - ConsumptionRequestWrongURL==============================================================
	...
	{	try {
		    response = AlertingErrorHandling.AlertingRequestWrongURL(ExcelInit.MSISDN, ExcelInit.Password); 
...
//===================================405 Method Not Allowed - ConsumptionPostRequest==============================================================
	...
	{	try {
		    response = AlertingErrorHandling.AlertingpostRequest(ExcelInit.MSISDN, ExcelInit.Password); 
...
//=====================================400 Bad request - ConsumptionRequestWrongURL==============================================================
	...
	{	try {
		    response = AlertingErrorHandling.AlertingWrongQparam(ExcelInit.MSISDN, ExcelInit.Password); 
...
//===================================500 Internal Server Error - Missing query param Request==============================================================
	...
	{	try {
		    response = AlertingErrorHandling.AlertingMissingQParamtRequest(ExcelInit.MSISDN, ExcelInit.Password); 
		    jsonString = Verification.BadRequest(response);
		} catch (Exception e) {ExtentReport.test.log(LogStatus.FAIL, "Exception in code happened and Auth status code is: " + Auth.StatusCode); 
		  e.printStackTrace();}
	}
//===================================415 Unsupported Media type - Request without Content-Type==============================================================
	...
	{	try {
		    response = AlertingErrorHandling.AlertingWithoutContentType(ExcelInit.MSISDN, ExcelInit.Password);
...
//===================================403 Forbidden - Request without different MSISDN==============================================================
	...
	{	try {
		    response = AlertingErrorHandling.AlertingWithDifferentMSISDN(ExcelInit.MSISDN, ExcelInit.Password);
